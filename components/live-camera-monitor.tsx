...
export function LiveCameraMonitor({cameras,organizationId,supabaseUrl,supabaseKey,canManage,onEvent,onZone,onCamera}:{cameras:VisionCamera[];organizationId:string;supabaseUrl:string;supabaseKey:string;canManage:boolean;onEvent:(event:VisionEvent)=>void;onZone:(id:string,points:Point[])=>void;onCamera:(camera:VisionCamera)=>void}){
