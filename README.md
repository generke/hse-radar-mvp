...
Free ограничен пятью работниками, пятью выдачами СИЗ, пятью документами и пятью единицами инвентаря. Ограничение работает в интерфейсе и на уровне Supabase trigger.
